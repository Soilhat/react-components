...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(function Button(
  ...
  const variantClasses: Record<ButtonVariant, Record<ColorName, string>> = {
    ...
    border: {
      primary: `border border-primary bg-transparent hover:bg-primary dark:border-primary-dark dark:hover:bg-primary-dark`,
      secondary: `border border-secondary bg-transparent hover:bg-secondary dark:border-secondary-dark dark:hover:bg-secondary-dark`,
      success: `border border-state-success bg-transparent hover:bg-state-success dark:border-state-success-dark dark:hover:bg-state-success-dark`,
      danger: `border border-state-danger bg-transparent hover:bg-state-danger dark:border-state-danger-dark dark:hover:bg-state-danger-dark`,
      warning: `border border-state-warning bg-transparent hover:bg-state-warning dark:border-state-warning-dark dark:hover:bg-state-warning-dark`,
      info: `border border-state-info bg-transparent hover:bg-state-info dark:border-state-info-dark dark:hover:bg-state-info-dark`,
