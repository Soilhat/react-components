import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as o}from"./iframe-DhWUdF5I.js";import{C as d}from"./Card-BKHo_NO-.js";import{c as m}from"./createLucideIcon-DJI1T-Cn.js";import"./preload-helper-Bni5rfja.js";const y=[["path",{d:"M21 12a9 9 0 1 1-9-9c2.52 0 4.93 1 6.74 2.74L21 8",key:"1p45f6"}],["path",{d:"M21 3v5h-5",key:"1q7to0"}]],w=m("rotate-cw",y);const b=[["path",{d:"M12 3v12",key:"1x0j5s"}],["path",{d:"m17 8-5-5-5 5",key:"7q97r8"}],["path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4",key:"ih7n3h"}]],v=m("upload",b),u=({initialImageUrl:t,placeholderImageUrl:r,uploadImage:n,isUploading:a=!1})=>{const[l,p]=o.useState(t||r),s=o.useRef(null),f=()=>{a||s.current?.click()},g=o.useCallback(h=>{const c=h.target.files?.[0];if(c){const x=URL.createObjectURL(c);p(x),n(c),s.current&&(s.current.value="")}},[n]);return o.useEffect(()=>{p(t||r)},[t,r]),e.jsxs("div",{className:"w-full max-w-sm mx-auto",children:[e.jsx(d,{className:`
