import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as C,R as k}from"./iframe-CkJjnvYH.js";import{S as I}from"./SwipeableRow-n3jE0hGd.js";import{C as w}from"./chevron-right-Dsca5rVW.js";import{B as R}from"./Button-OKByqS9U.js";import{c as v}from"./createLucideIcon-DTRdMYHR.js";import"./preload-helper-Bni5rfja.js";const E=[["path",{d:"m6 14 1.5-2.9A2 2 0 0 1 9.24 10H20a2 2 0 0 1 1.94 2.5l-1.54 6a2 2 0 0 1-1.95 1.5H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H18a2 2 0 0 1 2 2v2",key:"usdka0"}]],L=v("folder-open",E);const D=[["path",{d:"M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z",key:"1kt360"}]],F=v("folder",D);function u({items:r,parentId:t=null,level:d=0,renderItem:l,leftSwipeActions:a=[],rightSwipeActions:f=[]}){const[N,_]=C.useState(new Set),j=n=>{_(g=>{const o=new Set(g);return o.has(n)?o.delete(n):o.add(n),o})},x=r.filter(n=>n.parent_id===t);return x.length===0?null:e.jsx("div",{className:`
