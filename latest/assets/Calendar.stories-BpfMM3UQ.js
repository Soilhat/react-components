...
the onEventClick callback receives the clean ID (without the index suffix).`,...C.parameters?.docs?.description}}};const De=["DragAndDropInteractionTest","StaticMonthView","ClickInteractionTest"];export{C as ClickInteractionTest,S as DragAndDropInteractionTest,j as StaticMonthView,De as __namedExportsOrder,be as default};
