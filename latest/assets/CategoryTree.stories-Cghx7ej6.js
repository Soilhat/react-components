import{j as r}from"./jsx-runtime-u17CrQMm.js";import{r as s,R as C}from"./iframe-DHZ9nfwl.js";import{S as N}from"./SwipeableRow-B2WgqhMl.js";import{F as _}from"./ChevronRightIcon-DcSSr07L.js";import{B as I}from"./Button-0Aoe7CjV.js";import"./preload-helper-Bni5rfja.js";function f({items:e,parentId:n=null,level:a=0,renderItem:o,leftSwipeActions:d=[],rightSwipeActions:g=[]}){const[j,k]=s.useState(new Set),y=t=>{k(h=>{const l=new Set(h);return l.has(t)?l.delete(t):l.add(t),l})},b=e.filter(t=>t.parent_id===n);return b.length===0?null:r.jsx("div",{className:`
