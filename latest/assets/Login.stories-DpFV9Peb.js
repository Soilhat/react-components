import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as c}from"./iframe-CkJjnvYH.js";import{C as g}from"./Card-BXkEZ1u-.js";import{F as w}from"./Form-BryjSgsM.js";import{I as i}from"./Input-Dukctw0E.js";import{B as x}from"./Button-OKByqS9U.js";import"./preload-helper-Bni5rfja.js";import"./createLucideIcon-DTRdMYHR.js";function m({onSubmit:t}){const[n,a]=c.useState({username:void 0,password:void 0}),d=s=>{s.preventDefault(),t?t(n):console.log(n)},o=s=>{const{name:l,value:p}=s.target;a(u=>({...u,[l]:p}))};return e.jsxs(g,{className:"max-w-sm",children:[e.jsx("h2",{className:"text-primary text-2xl font-bold text-center mb-6",children:"Hello"}),e.jsxs(w,{id:"loginForm",onSubmit:d,children:[e.jsx(i,{name:"username",type:"string",label:"Username",placeholder:"Username",autoComplete:"off",onChange:o}),e.jsx(i,{type:"password",id:"password",name:"password",placeholder:"••••••••",label:"Password",onChange:o}),e.jsx(x,{type:"submit",children:"Login"})]}),e.jsx("p",{className:"text-center text-sm",children:e.jsx("a",{className:"text-primary hover:underline",href:"/auth/register",children:"Create Account"})})]})}m.__docgenInfo={description:"",methods:[],displayName:"Login",props:{onSubmit:{required:!1,tsType:{name:"signature",type:"function",raw:"(login: loginInfo) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
