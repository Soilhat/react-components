import{j as n}from"./jsx-runtime-u17CrQMm.js";import{r,R as k}from"./iframe-C6EgHmsB.js";import"./preload-helper-PPVm8Dsz.js";const p=({label:a,active:t=!1,onClick:s,icon:e,variant:u="primary",className:m="",disabled:c=!1})=>{const g={primary:"bg-primary dark:bg-primary-dark text-text-on-primary dark:text-text-on-primary-dark border-primary dark:border-primary-dark shadow-lg shadow-primary/20 dark:shadow-primary-dark/40",success:"bg-state-success dark:bg-state-success-dark text-text-on-primary dark:text-text-on-primary-dark border-state-success dark:border-state-success-dark shadow-lg shadow-state-success/20 dark:shadow-state-success-dark/40",danger:"bg-state-danger dark:bg-state-danger-dark text-text-on-primary dark:text-text-on-primary-dark border-state-danger dark:border-state-danger-dark shadow-lg shadow-state-danger/20 dark:shadow-state-danger-dark/40",warning:"bg-state-warning dark:bg-state-warning-dark text-text-on-primary dark:text-text-on-primary-dark border-state-warning dark:border-state-warning-dark shadow-lg shadow-state-warning/20 dark:shadow-state-warning-dark/40",ghost:"bg-text-primary dark:bg-text-primary-dark text-text-on-primary dark:text-text-on-primary-dark border-text-primary dark:border-text-primary-dark"};return n.jsxs("button",{onClick:c?void 0:s,disabled:c,className:`
