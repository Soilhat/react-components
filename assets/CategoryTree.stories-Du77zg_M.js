import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as o,R as y}from"./iframe-BG6SSSvD.js";import{S as C}from"./SwipeableRow-3WFnqKeg.js";import{B as _}from"./Button-Cny4Hn02.js";import{F as I}from"./ChevronRightIcon-PXgJoxG4.js";import"./preload-helper-PPVm8Dsz.js";function f({items:r,parentId:a=null,level:t=0,renderItem:s,leftSwipeActions:d=[],rightSwipeActions:g=[]}){const[j,k]=o.useState(new Set),N=n=>{k(h=>{const l=new Set(h);return l.has(n)?l.delete(n):l.add(n),l})},x=r.filter(n=>n.parent_id===a);return x.length===0?null:e.jsx("div",{className:`
