import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as c}from"./iframe-C6EgHmsB.js";import{T as y}from"./Text-r8h_yXJX.js";import"./preload-helper-PPVm8Dsz.js";const m=c.forwardRef(function({label:p,description:d,className:u="",containerClassName:b="",id:x,indeterminate:i,...f},g){const h=c.useRef(null),r=g||h,l=x||`checkbox-${Math.random().toString(36).slice(2,9)}`;return c.useEffect(()=>{"current"in r&&r.current&&(r.current.indeterminate=!!i)},[r,i]),e.jsxs("div",{className:`relative flex items-start gap-3 p-3 rounded-xl transition-colors hover:bg-surface-base/50 dark:hover:bg-surface-base-dark/30 ${b}`,children:[e.jsx("div",{className:"flex h-6 items-center",children:e.jsx("input",{id:l,ref:r,type:"checkbox",className:`
...
}`,...n.parameters?.docs?.source}}};const w=["Default","WithDescription","Indeterminate","ComplexCard","Disabled"];export{o as ComplexCard,s as Default,n as Disabled,t as Indeterminate,a as WithDescription,w as __namedExportsOrder,j as default};
