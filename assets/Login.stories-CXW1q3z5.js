import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as c}from"./iframe-zLDVJhYU.js";import{C as g}from"./Card-DIn0jlbj.js";import{F as x}from"./Form-BJyusw0Q.js";import{I as i}from"./Input-J8HrwLfH.js";import{B as w}from"./Button-2kxwfnik.js";import"./preload-helper-PPVm8Dsz.js";import"./Heading-Cae_zCKo.js";import"./index-CvglTX43.js";function m({onSubmit:t}){const[n,a]=c.useState({username:void 0,password:void 0}),d=s=>{s.preventDefault(),t?t(n):console.log(n)},o=s=>{const{name:l,value:p}=s.target;a(u=>({...u,[l]:p}))};return e.jsxs(g,{className:"max-w-sm",children:[e.jsx("h2",{className:"text-secondary-700 dark:text-primary-300 text-2xl font-bold text-center mb-6",children:"Hello"}),e.jsxs(x,{id:"loginForm",onSubmit:d,children:[e.jsx(i,{name:"username",type:"string",label:"Username",placeholder:"Username",autoComplete:"off",size:"md",variant:"outline",onChange:o}),e.jsx(i,{type:"password",id:"password",name:"password",placeholder:"••••••••",label:"Password",size:"md",variant:"outline",onChange:o}),e.jsx(w,{type:"submit",children:"Login"})]}),e.jsx("p",{className:"text-center text-sm",children:e.jsx("a",{className:"text-accent hover:underline",href:"/auth/register",children:"Create Account"})})]})}m.__docgenInfo={description:"",methods:[],displayName:"Login",props:{onSubmit:{required:!1,tsType:{name:"signature",type:"function",raw:"(login: loginInfo) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:`{
