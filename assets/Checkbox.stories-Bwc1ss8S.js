import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as u}from"./iframe-Bj9APFbg.js";import"./preload-helper-PPVm8Dsz.js";const N={h1:"text-2xl sm:text-3xl font-black tracking-tight",h2:"text-xl sm:text-2xl font-bold",h3:"text-lg sm:text-xl font-bold",body:"text-sm sm:text-base leading-snug sm:leading-relaxed",small:"text-[13px] sm:text-sm",detail:"text-[10px] sm:text-xs uppercase tracking-widest font-bold opacity-60"},f=({as:b,variant:d="body",bold:t=!1,className:c="",children:m,...p})=>{const r=b??"p";return e.jsx(r,{className:`
        ${N[d]} 
        ${t?"font-bold":""} 
        ${c}
      `.trim().replace(/\s+/g," "),...p,children:m})};f.__docgenInfo={description:"",methods:[],displayName:"Text",props:{as:{required:!1,tsType:{name:"T"},description:""},variant:{required:!1,tsType:{name:"union",raw:"'h1' | 'h2' | 'h3' | 'body' | 'small' | 'detail'",elements:[{name:"literal",value:"'h1'"},{name:"literal",value:"'h2'"},{name:"literal",value:"'h3'"},{name:"literal",value:"'body'"},{name:"literal",value:"'small'"},{name:"literal",value:"'detail'"}]},description:"",defaultValue:{value:"'body'",computed:!1}},bold:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},className:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"''",computed:!1}},children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}}};const g=u.forwardRef(function({label:d,description:t,className:c="",containerClassName:m="",id:p,indeterminate:r,...h},y){const v=u.useRef(null),a=y||v,x=p||`checkbox-${Math.random().toString(36).slice(2,9)}`;return u.useEffect(()=>{"current"in a&&a.current&&(a.current.indeterminate=!!r)},[a,r]),e.jsxs("div",{className:`relative flex items-start gap-3 p-3 rounded-xl transition-colors hover:bg-surface-base/50 dark:hover:bg-surface-base-dark/30 ${m}`,children:[e.jsx("div",{className:"flex h-6 items-center",children:e.jsx("input",{id:x,ref:a,type:"checkbox",className:`
